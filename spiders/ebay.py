...
class EbaySpider(scrapy.Spider):
	...
	def parse(self, response):
		...
		# Build the url and start the requests https://www.ebay.com/b/Laptops-Netbooks/175672/bn_1648276?rt=nc&_pgn=1
		yield scrapy.Request("https://www.ebay.com/b/Laptops-Netbooks/175672/bn_1648276?rt=nc&_pgn=1")
